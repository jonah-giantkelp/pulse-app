...
#ifndef PULSENOTIFICATIONSERVICE_SWIFT_H
#define PULSENOTIFICATIONSERVICE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PulseNotificationService",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// in <code>artist_images</code>; whatever downloads in time gets drawn, and the push
/// is delivered unmodified if nothing does.
SWIFT_CLASS("_TtC24PulseNotificationService19NotificationService")
